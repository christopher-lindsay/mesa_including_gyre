...
! ***********************************************************************
      ...
      subroutine extras_after_evolve(id, ierr)
         ...
         tolerance = 1d-2
         !call check('delta_nu GYRE vs MESA', abs(s%delta_nu-s%delta_nu_from_gyre)/s%delta_nu_from_gyre,  -tolerance, tolerance)
         ...
         subroutine check(str, val, low, hi)
             ...
             if (low <= val .and. val <= hi) then
                 write(*,1) 'Test', 'Value', 'Lower rel. tolerance', 'Upper rel. tolerance'
